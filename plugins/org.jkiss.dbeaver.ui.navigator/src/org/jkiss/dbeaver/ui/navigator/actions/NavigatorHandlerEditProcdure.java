...
public class NavigatorHandlerEditProcdure extends NavigatorHandlerObjectBase implements IElementUpdater {

    private static final Log log = Log.getLog(NavigatorHandlerEditProcdure.class);
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            for (Iterator<?> iter = structSelection.iterator(); iter.hasNext(); ) {
                ...
                if (node != null) {
                    NavigatorUtils.editNavigatorNode(node, HandlerUtil.getActiveWorkbenchWindow(event), event.getParameters());
                }
            }
        }
        return null;
    ...
    {
        return openEntityEditor(selectedNode, defaultPageId, new String("mysql.source.view") , null, workbenchWindow, true);
    }
            ...
            if (node != null) {
                ...
                if (node instanceof DBNDataSource) {
                    ...
                    if (object != null) {
                        ...
                        actionName = UINavigatorMessages.actions_navigator_edit_procedure;
                    }
                }
                String label;
